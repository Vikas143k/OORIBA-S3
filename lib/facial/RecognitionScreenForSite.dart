...
Future<void> _toggleCheckInCheckOut(String employeeId) async {
  ...
  final checkInOutData = await firestoreService.getCheckInOutDataByEmployeeId(employeeId, now);
  setState(() {
  ...
  bool isFaceRecognized() {
    ...
    if (_image != null && isFaceRecognized()) {
      String employeeId = recognitions.first.name; // Assuming only one face is recognized
                ...
                child: InkWell(
                  ...
                  child: SizedBox(
                    ...
                    child: Icon(Icons.arrow_forward,
                        color: const Color.fromARGB(255, 33, 243, 33), size: screenWidth / 7),
                  ),
                ),
              ),
            ],
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Recognition rectangle in facesList) {
      ...
      TextSpan span = TextSpan(
          style: const TextStyle(color: Colors.black, fontSize: 100,fontWeight: FontWeight.bold),
